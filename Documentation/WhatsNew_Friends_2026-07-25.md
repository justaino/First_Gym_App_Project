...
Athena's Arena now has friends. You can see who's training, cheer each other on,
and (if you want) show them what you've actually been lifting.

Open the app and you'll find a new **🤝 Friends** tab at the bottom.
...
⚠️ Nudges appear **inside the app**, not as a phone notification. Your friend
sees it next time they open Athena's Arena, not on their lock screen.

---

## On the Today tab

A **Gym buddies** panel now shows who's trained today at a glance. Tap the
heading to fold it away if you'd rather not see it — it stays folded until you
open it again.
...
- **Everything here needs a connection.** Friends data lives in the cloud, so
